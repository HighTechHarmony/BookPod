...
# Feed loading, XML parsing, and disk-caching logic now live in feed.py
# (shared with the FastAPI web app in main.py). This script only provides the
# CLI interface and static HTML rendering.
